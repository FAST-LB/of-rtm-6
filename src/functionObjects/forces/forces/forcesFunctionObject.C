...
{
    defineTypeNameAndDebug(forcesFunctionObject, 0);

    addToRunTimeSelectionTable(functionObject, forcesFunctionObject, dictionary);
}
}
...
Foam::wordList Foam::functionObjects::forcesFunctionObject::createFileNames
(
...
void Foam::functionObjects::forcesFunctionObject::writeFileHeader(const label i)
{
    switch (fileID(i))
    {
        case MAIN_FILE:
...
void Foam::functionObjects::forcesFunctionObject::initialise()
{
    if (initialised_)
    {
        return;
...
Foam::functionObjects::forcesFunctionObject::devRhoReff() const
{
...
Foam::tmp<Foam::volScalarField> Foam::functionObjects::forcesFunctionObject::mu() const
{
...
Foam::tmp<Foam::volScalarField> Foam::functionObjects::forcesFunctionObject::rho() const
{
    if (rhoName_ == "rhoInf")
    {
...
Foam::scalar Foam::functionObjects::forcesFunctionObject::rho(const volScalarField& p) const
{
...
void Foam::functionObjects::forcesFunctionObject::applyBins
(
...
void Foam::functionObjects::forcesFunctionObject::writeForces()
{
...
void Foam::functionObjects::forcesFunctionObject::writeBins()
{
    if (nBin_ == 1)
    {
        return;
...
Foam::functionObjects::forcesFunctionObject::forcesFunctionObject
(
    const word& name,
    const Time& runTime,
    const dictionary& dict
...
bool Foam::functionObjects::forcesFunctionObject::read(const dictionary& dict)
{
...
void Foam::functionObjects::forcesFunctionObject::calcForcesMoment()
{
    initialise();
...
Foam::vector Foam::functionObjects::forcesFunctionObject::forceEff() const
{
    return sum(force_[0]) + sum(force_[1]) + sum(force_[2]);
}


Foam::vector Foam::functionObjects::forcesFunctionObject::momentEff() const
{
    return sum(moment_[0]) + sum(moment_[1]) + sum(moment_[2]);
}


bool Foam::functionObjects::forcesFunctionObject::execute()
{
    return true;
}


bool Foam::functionObjects::forcesFunctionObject::write()
{
    calcForcesMoment();
